...
def run(rr_type,
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        if rr_input_file_format=='csv':
            ...
            logging.error('Cannot interpret the RR input file format: '+str(rr_input_file_format))
            return b'', b'', b'', b'rr_input_format'
        ...
        if rp2_results[1]==b'timeouterror' or rp2_results[1]==b'timeoutwarning':
            ...
            return rp2_results[0], rp2paths_results[0], rp2paths_results[1], n'noerrors'
        else:
