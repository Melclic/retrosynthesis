...
def run_rp2paths(rp2_pathways_bytes, timeout, ram_limit=None, logger=None):
    ...
    with tempfile.TemporaryDirectory() as tmpOutputFolder:
        ...
        rp2paths_command = 'python /home/rp2paths/RP2paths.py all '+str(rp2_pathways)+' --outdir '+str(tmpOutputFolder)+'/ --timeout '+str(int(timeout*60.0))
        try:
